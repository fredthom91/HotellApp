...
namespace HotellApp.Data
{
    public static class CustomizationMenu
    {
        ...
        public static int Menu()
        {
             ...
             .AddChoices(new[] {
             "[yellow]Lägg till ett nytt rum[/]",
             "[yellow]Se alla rum[/]",
             "[yellow]Ändra/Hantera ett rum[/]",
             "[yellow]Ta bort ett rum[/]",
             "[yellow]Registrera en ny kund[/]",
             "[yellow]Se alla kunder[/]",
             "[yellow]Ändra/Hantera en kund[/]",
             "[yellow]Ta bort en kund[/]",
             "[yellow]Lägg till sängar[/]",
             "[yellow]Ta bort sängar[/]",
             "[yellow]Gå till Bokningsmeny[/]",
             "[red]Avsluta[/]"
             }));
